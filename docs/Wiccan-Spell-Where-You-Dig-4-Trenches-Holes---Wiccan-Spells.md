...
每个沟槽代表四大元素之一：土、气、火和水。通过这些元素，巫术从业者可以访问与每个元素相关的能量，并将它们融入到他们的咒语工作中。这些沟槽作为导管，允许从业者连接这些元素力量，并利用它们独特的属性来增强咒语的效果。
...
1.  **结束咒语：** 感谢大地和元素在你的咒语中的帮助。将壕沟重新填满土壤，象征性地将能量和意图释放到地球，让宇宙来实现。
