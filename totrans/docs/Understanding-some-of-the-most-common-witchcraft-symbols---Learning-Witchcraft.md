...
# Understanding some of the most common witchcraft symbols - Learning Witchcraft
...
## A Breakdown of Different Witchcraft Symbols

If you are part of the New Age movement of practice or of witchcraft or paganism, you need to get an understanding of the symbols that are often used throughout. By understanding these symbols, you will be able to demystify this lifestyle and get a clear understanding of it. So much fantasy and hocus-pocus has been written about witchcraft or otherwise passed on, to the point that many people get the wrong idea about it. Because of this, you will need to learn all that you can in order to get a clear understanding for what it is and what it is not.
...
The root of the Setogram traces back to the number 7\. In numerology and a number of different religious practices, the number 7 has taken on plenty of different connotations and meanings. Because of this, it has often been used by a specific culture, in relation to whatever meaning they ascribe to the number 7\. In many mythologies, it has also been used to represent elves and fairies and the types of magic that they are said to wield.
